package com.app.kiyalearning.student.dashboard
...
import com.app.kiyalearning.databinding.StudentActivityDashboardBinding
...
import com.app.kiyalearning.student.dashboard.ui.notifications.NotificationActivity
...
class DashBoardActivity : AppCompatActivity() {
    ...
    var binding: StudentActivityDashboardBinding?=null
...
//            .build ( )
       ...
       else if (intent.getBooleanExtra("IS_CHAT_ACTIVITY",false))
        {
            ...
            try {
                ...
                Log.d("Notification","Student Dashboard data $chat")
