...
class CompletedFragment : MyFragment(), MyClassesAdapter.OnViewHomeWorkListener {
    ...
    override fun onCreateView(
        ...
        classesAdapter = MyClassesAdapter(classList,this@CompletedFragment)
    ...
    override fun onViewFile(model: StudentClass) {
        if (model.classHomeWork?.isNotEmpty()!!){
            val i = Intent(Intent.ACTION_VIEW,Uri.parse(model.classHomeWork))
            startActivity(i)
        }else{
