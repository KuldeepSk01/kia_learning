package com.app.kiyalearning.student.dashboard.ui.home.librarySliders
...
import com.app.kiyalearning.student.dashboard.ui.home.adapters.LibraryAdapter
import com.app.kiyalearning.student.dashboard.ui.home.pojos.LibraryData
import com.app.kiyalearning.student.dashboard.ui.home.viewmodels.LibraryViewModel
    ...
    override fun onCreateView(
        ...
        binding.pullToRefresh.setOnRefreshListener {
            if (MyNetworks.isNetworkAvailable(requireActivity())) {
                viewModel.getLibraryList(requireActivity(),"Course")
            }
        }
