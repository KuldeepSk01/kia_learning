package com.app.kiyalearning.teacher.dashboard.ui.notifications.viewmodel
...
class NotificationViewModel : ViewModel() {
  ...
  //  lateinit var selectedImageUrl: String
    ...
    fun getNotificationsList(context: Context)
    {
        ...
        val call: Call<NotificationsResponse> =  RestManager.getInstance().getNotifications(AppPref.getTokenType(context)+" "+ AppPref.getUserToken(context))
