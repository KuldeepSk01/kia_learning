package com.app.kiyalearning.teacher.dashboard
...
import com.app.kiyalearning.databinding.TeacherActivityDashboardBinding
import com.app.kiyalearning.location.MapsLocationActivity
import com.app.kiyalearning.teacher.dashboard.ui.home.HomeFragment
import com.app.kiyalearning.teacher.dashboard.ui.notifications.NotificationActivity
...
class DashBoardActivity : AppCompatActivity() {
    ...
    var binding: TeacherActivityDashboardBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TeacherActivityDashboardBinding.inflate(layoutInflater)
        setContentView(binding!!.root)
        checkForUpdate()

        UtilClass.setStatusBarProperty(this)

        binding!!.address.text = AppPref.getLocName(this)
...
//            .build ( )
        ...
        if (intent.getBooleanExtra("IS_NOTIFICATION", false)) {
            ...
            try {
              ...
              //  val groupIcon = intent.getStringExtra("group_icon")
                ...
                Log.d("Notification","Teacher Dashboard data $chat")
               ...
               // finish()
                ...
                Log.d("Notification","Teacher Dashboard data Error ${e.message}")
            }


           // startActivity(Intent(this, ChatListActivity::class.java))
        } else if (intent.getBooleanExtra("OPEN_CLASSES_TAB", false)) {
            binding!!.navView.selectedItemId = R.id.navigation_classes
        }
    ...
    override fun onBackPressed() {
        if (binding?.navView!!.selectedItemId != R.id.navigation_home) {
            ...
            Toast.makeText(this, getString(R.string.press_back_again_exit), Toast.LENGTH_SHORT)
                .show()
    ...
    private fun checkForUpdate() {
        val appUpdateManager = AppUpdateManagerFactory.create(this@DashBoardActivity)
