...
class CancelledFragment :MyFragment(){
    ...
    override fun onCreateView(
        ...
        classesAdapter= MyClassesAdapter(classList, "rejected", viewModel, binding)
        binding.recycleView.adapter = classesAdapter

        binding.pullToRefresh.setOnRefreshListener {
            if (MyNetworks.isNetworkAvailable(requireActivity())) {
                viewModel.getClassesList(requireActivity(),"rejected",dateTextViewId,studentName)
            }
        }
