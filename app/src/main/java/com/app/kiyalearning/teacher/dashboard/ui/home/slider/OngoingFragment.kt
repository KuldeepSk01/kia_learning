...
class OngoingFragment : MyFragment() {
    ...
    override fun onCreateView(
        ...
        classesAdapter = MyClassesAdapter(classList, "ongoing", viewModel, binding)
        binding.recycleView.adapter = classesAdapter

        binding.pullToRefresh.setOnRefreshListener {
            if (MyNetworks.isNetworkAvailable(requireActivity())) {
                viewModel.getClassesList(requireActivity(), "ongoing", dateTextViewId, studentName)
            }
        }
